...
const { print, on, off, move, click } = require('./utils.js');
...
function onKeydown(e) {
  // print('reach onKeydown at line 489');
  // print('code: ', e.code);
  // print('this[inComposition]: ', this[inComposition]);
  // print('e: ', e);
  // onBackClick.call(this);
  // onForwardClick.call(this);
...
function findKeep(forward) {
  ...
  // print({ win: this.webContents });
  // forward ? document.querySelector('.find-forward').click() : document.querySelector('.find-back').click();
...
function onForwardClick() {
  // print('onForwardClick:::', 'this[action]:::', this[action]);
  // print('onForwardClick:::', 'this[findInput]:::', this[findInput]);
  // print('onForwardClick:::', 'this[findCase]:::', this[findCase]);
  // print('onForwardClick:::', 'this[matchCase]:::', this[matchCase]);
  // print('findForward:::', this[findForward]);
  this[action] = 'forward';
  wrapInput(this[findInput], this[findCase], 100);
